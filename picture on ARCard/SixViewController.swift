...
class SixViewController: UIViewController, PickerViewKeyboardDelegate {
    ...
    @IBAction func StarbacksTapped(_ sender: UIButton) {
        guard let url = URL(string: "https://loco.yahoo.co.jp/place/g-5yIasR6MdxM/?genrecd=01") else { return }
