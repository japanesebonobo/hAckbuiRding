//
//  ThreeFloorViewController.swift
//  picture on ARCard
//
...
class ThreeFloorViewController: UIViewController, PickerViewKeyboardDelegate {
    ...
    @IBAction func AfternoonTapped(_ sender: UIButton) {
        guard let url = URL(string: "https://loco.yahoo.co.jp/place/g-Zef3TUeaGuY/") else { return }
